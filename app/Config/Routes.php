...
// Return all brands that are restaurants
$routes->get('brand/restaurant', 'Brand::getRestaurantEntries');

// Return restaurant entries by name
$routes->get('brand/restaurant/name', 'Brand::getRestaurantEntriesByName');
